...
class InteractiveCurvedMPR:
    def __init__(self, data, downsample_factor=2):
        ...
        self.curve_factor = 0.4  # زيادة الانحناء الافتراضي
        self.active_view = 'axial'  # الـ view النشط
        self.mpr_height = 140  # زيادة الارتفاع
        self.mpr_points = 300  # زيادة الدقة
    ...
    def setup_ui(self):
        ...
        self.ax_axial.set_title('AXIAL', fontweight='bold', color='white', fontsize=14,
                               pad=10,
        ...
        self.img_axial = self.ax_axial.imshow(self.data[:, :, self.current_slice_ax].T, 
                                              cmap='gray', origin='lower', picker=True, vmin=0, vmax=1)
        self.ax_axial.axis('off')
        
        # Coronal view
        self.ax_coronal = self.fig.add_subplot(gs[0, 1])
        self.ax_coronal.set_facecolor('#000000')
        self.ax_coronal.set_title('CORONAL', fontweight='bold', color='white', fontsize=14,
                                 pad=10,
        ...
        self.ax_sagittal.set_title('SAGITTAL', fontweight='bold', color='white', fontsize=14,
                                  pad=10,
        ...
        self.ax_mpr.set_title('⬤ CURVED MULTIPLANAR RECONSTRUCTION ⬤', 
        ...
        self.ax_mpr.text(0.5, 0.5, 'Ready to generate MPR • Click path points above', 
    ...
    def generate_mpr(self, event):
        ...
        if len(self.points) < 2:
            ...
            self.ax_mpr.clear()
            self.ax_mpr.text(0.5, 0.5, '⚠ Add at least 2 points first!', 
        ...
        self.ax_mpr.set_title(f'⬤ CURVED MPR  |  Generated in {time.time()-start_time:.2f}s  |  High Resolution ⬤', 
                             fontweight='bold', fontsize=16, color='#00E676',
                             pad=15,
                             bbox=dict(boxstyle='round,pad=0.8', facecolor='#1a1a1a',
                                     edgecolor='#00E676', linewidth=3, alpha=0.98))
        self.ax_mpr.set_xlabel('Position along curved path  →', fontsize=13, fontweight='bold', color='#64B5F6')
        self.ax_mpr.set_ylabel('⟂  Perpendicular distance (voxels)', fontsize=13, fontweight='bold', color='#64B5F6')
        ...
        self.fig.canvas.draw_idle()
        print(f"✓ MPR generated in {time.time()-start_time:.1f} seconds")
    ...
    def clear_points(self, event):
        ...
        self.points = []
        self.ax_mpr.clear()
        self.ax_mpr.set_title('★ CURVED MPR - Select points and click "Generate MPR" ★', 
...
def main():
    """البرنامج الرئيسي"""
    print("="*60)
    print("INTERACTIVE CURVED MPR VIEWER")
    print("="*60)
    ...
    print("\nInstructions:")
    print("  1. Click on any view (Axial/Coronal/Sagittal) to add points")
    print("  2. Add at least 2 points to define a path")
    print("  3. Adjust 'Curve' slider to change curvature")
    print("  4. Click 'Generate MPR' to create the curved reconstruction")
    print("  5. Use 'Undo Last' to remove last point")
    print("  6. Use 'Clear Points' to start over")
    print("\n" + "="*60 + "\n")
